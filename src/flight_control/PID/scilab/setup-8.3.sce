...
tsd =   0.4;   // Desired Settling Time
pod =  1.05;   // Desired Percent Overshoot
ssed =  0.0;   // Desired Steady State Error

cu_max = 800.0;  //  Normalization value for control effort.



////////////////////////////   Search range and step

nvals = 15;  // number of gain values to try btwn kmax and kmin
