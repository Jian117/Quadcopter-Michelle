...
//        printf("current roll:");
//        printFloat(ctrl_data->roll);
//        printf(" degrees \n\r");
//
//        printf("current pitch:");
//        printFloat(ctrl_data->pitch);
//        printf(" degrees \n\r");
    }
}
...
void motor_test(unsigned int sign, unsigned int value, unsigned int motor_num) {
    ...
    printf("M%d: %u.\n\r", motor_num, result-ZERO_SPEED_THROTTLE);
...
//    double period;
//    period = 360.0;
//    while (new_yaw - YAW_LOW_BOND < 0 || new_yaw - YAW_HIGH_BOND > 0) {
