...
unsigned int read_sensor(void)
{
    ...
    temp      =  (temp << 8) | I2C_RX_buffer_ptr[10];
    temp      =  (temp << 8) | I2C_RX_buffer_ptr[11];
    temp      =  (temp << 8) | I2C_RX_buffer_ptr[12];
    ctrl_data->yaw = ((double)temp)/1000;
    
//    temp =  I2C_RX_buffer_ptr[13];
//    temp =  (temp << 8) | I2C_RX_buffer_ptr[14];
//    temp =  (temp << 8) | I2C_RX_buffer_ptr[15];
//    temp =  (temp << 8) | I2C_RX_buffer_ptr[16];
