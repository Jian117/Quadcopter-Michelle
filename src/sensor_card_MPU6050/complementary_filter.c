...
//   }
   ...
   //Direction (y<0) = 270 - [arcTAN(x/y)]*180/Pi
    ...
    //sensor_data_ptr->pitch += ((float)sensor_data_ptr->angular_velocity_X  ) * dt; // Angle around the X-axis
    //sensor_data_ptr->roll  -= ((float)sensor_data_ptr->angular_velocity_Y  ) * dt;    // Angle around the Y-axis
