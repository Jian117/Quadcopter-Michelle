...
//        
//            printFloat(sensor_data_ptr->angular_velocity_X);
//            printFloat(sensor_data_ptr->angular_velocity_Y);
//            printFloat(sensor_data_ptr->angular_velocity_Z);
            
           //printFloat(sensor_data_ptr->pitch);
           //printFloat(sensor_data_ptr->roll);
            //printFloat(sensor_data_ptr->yaw);

         //printf("%d, %d, %d\n\r",sensor_data_ptr->compass_X, sensor_data_ptr->compass_Y, sensor_data_ptr->compass_Z);
